...
export function getLocalDateRangeInclusive(startDate: string, endDate: string): { start: string; end: string } {
  const start = getLocalDateRange(startDate).start
  const end = getLocalDateRange(endDate).end
